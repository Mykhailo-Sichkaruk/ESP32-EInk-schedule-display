...
fn main() -> anyhow::Result<()> {
    ...
    let time_intervals = vec![
        TimeInterval::new(
            chrono::NaiveDateTime::new(today, chrono::NaiveTime::from_hms_opt(5, 50, 0).unwrap()),
            chrono::NaiveDateTime::new(today, chrono::NaiveTime::from_hms_opt(6, 20, 0).unwrap()),
            "xsichkaruk",
        )?,
        TimeInterval::new(
            chrono::NaiveDateTime::new(today, chrono::NaiveTime::from_hms_opt(6, 20, 0).unwrap()),
        ...
        TimeInterval::new(
            ...
            chrono::NaiveDateTime::new(today, chrono::NaiveTime::from_hms_opt(11, 15, 0).unwrap()),
            "SomeEventNameasdasdasdlas\n\n\n\n\njdkasjdhkajsdhasjkdhaskd",
        )?,
        TimeInterval::new(
